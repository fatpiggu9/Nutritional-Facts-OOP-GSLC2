	...
	public static void main(String[] args) {
		...
		do {
			...
			if(option == 1) {
				...
				double proteinAmount = chicken.calculateProtein(weight);				
				chicken.calculateNutrients(weight);
				chicken.checkProteinRequirement(proteinAmount, gender);
			}
				...
				Fish fish = new Fish();
				double proteinAmount = fish.calculateProtein(weight);
				fish.calculateNutrients(weight);
				fish.checkProteinRequirement(proteinAmount, gender);
			}
				...
				Eggs eggs = new Eggs();
				double proteinAmount = eggs.calculateProtein(weight);
				eggs.calculateNutrients(weight);
				eggs.checkProteinRequirement(proteinAmount, gender);
			}
